(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('primeng-lts/overlaypanel', ['@angular/core','@angular/common','primeng-lts/api','exports', '@angular/core', '@angular/common', 'primeng-lts/dom', 'primeng-lts/api', '@angular/animations'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].overlaypanel = {}), global.ng.core, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].api, global.ng.animations));
...
OverlayPanelModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function OverlayPanelModule_Factory(t) { return new (t || OverlayPanelModule)(); }, imports: [[common.CommonModule, api.SharedModule], ɵngcc2.SharedModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(OverlayPanelModule, { declarations: [OverlayPanel], imports: [ɵngcc1.CommonModule, ɵngcc2.SharedModule], exports: [OverlayPanel, ɵngcc2.SharedModule] }); })();
