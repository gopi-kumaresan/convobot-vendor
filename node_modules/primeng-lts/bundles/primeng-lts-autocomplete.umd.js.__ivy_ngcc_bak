(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/animations'), require('primeng-lts/inputtext'), require('primeng-lts/button'), require('primeng-lts/api'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/autocomplete', ['exports', '@angular/core', '@angular/common', '@angular/animations', 'primeng-lts/inputtext', 'primeng-lts/button', 'primeng-lts/api', 'primeng-lts/dom', 'primeng-lts/utils', '@angular/forms'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].autocomplete = {}), global.ng.core, global.ng.common, global.ng.animations, global['primeng-lts'].inputtext, global['primeng-lts'].button, global['primeng-lts'].api, global['primeng-lts'].dom, global['primeng-lts'].utils, global.ng.forms));
