(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/forms'),exports, require('@angular/core'), require('@angular/forms'), require('@angular/common'), require('primeng-lts/dom'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/terminal', ['@angular/core','@angular/common','@angular/forms','exports', '@angular/core', '@angular/forms', '@angular/common', 'primeng-lts/dom', 'rxjs'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.forms,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].terminal = {}), global.ng.core, global.ng.forms, global.ng.common, global['primeng-lts'].dom, global.rxjs));
