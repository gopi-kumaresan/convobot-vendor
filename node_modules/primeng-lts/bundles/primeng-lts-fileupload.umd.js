(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/common/http'),require('@angular/common'),require('primeng-lts/button'),require('primeng-lts/messages'),require('primeng-lts/progressbar'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('primeng-lts/button'), require('primeng-lts/messages'), require('primeng-lts/progressbar'), require('primeng-lts/dom'), require('primeng-lts/api'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/fileupload', ['@angular/core','@angular/platform-browser','@angular/common/http','@angular/common','primeng-lts/button','primeng-lts/messages','primeng-lts/progressbar','primeng-lts/api','exports', '@angular/core', '@angular/common', '@angular/platform-browser', 'primeng-lts/button', 'primeng-lts/messages', 'primeng-lts/progressbar', 'primeng-lts/dom', 'primeng-lts/api', '@angular/common/http'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.common.http,global.ng.common,global.primengLts.button,global.primengLts.messages,global.primengLts.progressbar,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].fileupload = {}), global.ng.core, global.ng.common, global.ng.platformBrowser, global['primeng-lts'].button, global['primeng-lts'].messages, global['primeng-lts'].progressbar, global['primeng-lts'].dom, global['primeng-lts'].api, global.ng.common.http));
