(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('primeng-lts/api'), require('@angular/common'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/carousel', ['exports', '@angular/core', 'primeng-lts/api', '@angular/common', 'primeng-lts/utils'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].carousel = {}), global.ng.core, global['primeng-lts'].api, global.ng.common, global['primeng-lts'].utils));
