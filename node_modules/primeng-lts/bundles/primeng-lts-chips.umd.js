(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/inputtext'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/inputtext'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/chips', ['@angular/core','@angular/common','primeng-lts/inputtext','primeng-lts/api','exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/inputtext', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.inputtext,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].chips = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].inputtext, global.ng.forms));
...
function Chips_li_2_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Chips_li_2_span_2_Template_span_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r10); var i_r3 = ɵngcc0.ɵɵnextContext().index; var ctx_r8 = ɵngcc0.ɵɵnextContext(); return ctx_r8.removeItem($event, i_r3); });
    ɵngcc0.ɵɵelementEnd();
} }
