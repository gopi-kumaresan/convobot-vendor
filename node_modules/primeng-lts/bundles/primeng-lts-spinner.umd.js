(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/inputtext'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/inputtext'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/spinner', ['@angular/core','@angular/common','primeng-lts/inputtext','exports', '@angular/core', '@angular/common', 'primeng-lts/inputtext', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.inputtext,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].spinner = {}), global.ng.core, global.ng.common, global['primeng-lts'].inputtext, global.ng.forms));
