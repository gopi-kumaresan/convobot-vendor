(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('primeng-lts/menu', ['@angular/core','@angular/common','@angular/router','exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', '@angular/router'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.router,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].menu = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global.ng.router));
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MenuModule, { declarations: [Menu, MenuItemContent], imports: [ɵngcc1.CommonModule, ɵngcc2.RouterModule], exports: [Menu, ɵngcc2.RouterModule] }); })();
