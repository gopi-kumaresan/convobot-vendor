(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('primeng-lts/dom'), require('primeng-lts/paginator'), require('primeng-lts/api'), require('primeng-lts/utils'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/treetable', ['exports', '@angular/core', '@angular/common', 'rxjs', 'primeng-lts/dom', 'primeng-lts/paginator', 'primeng-lts/api', 'primeng-lts/utils', '@angular/cdk/scrolling'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].treetable = {}), global.ng.core, global.ng.common, global.rxjs, global['primeng-lts'].dom, global['primeng-lts'].paginator, global['primeng-lts'].api, global['primeng-lts'].utils, global.ng.cdk.scrolling));
