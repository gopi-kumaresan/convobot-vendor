(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/paginator'),require('@angular/cdk/scrolling'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('rxjs'), require('primeng-lts/dom'), require('primeng-lts/paginator'), require('primeng-lts/api'), require('primeng-lts/utils'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/treetable', ['@angular/core','@angular/common','primeng-lts/paginator','@angular/cdk/scrolling','primeng-lts/api','exports', '@angular/core', '@angular/common', 'rxjs', 'primeng-lts/dom', 'primeng-lts/paginator', 'primeng-lts/api', 'primeng-lts/utils', '@angular/cdk/scrolling'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.paginator,global.ng.cdk.scrolling,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].treetable = {}), global.ng.core, global.ng.common, global.rxjs, global['primeng-lts'].dom, global['primeng-lts'].paginator, global['primeng-lts'].api, global['primeng-lts'].utils, global.ng.cdk.scrolling));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,ɵngcc4,exports, core, common, rxjs, dom, paginator, api, utils, scrolling) { 
var _c0 = ["container"];
...
function TreeTable_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function TreeTable_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r14); var ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onPageChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function TreeTable_p_paginator_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function TreeTable_p_paginator_8_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r23); var ctx_r22 = ɵngcc0.ɵɵnextContext(); return ctx_r22.onPageChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
        ...
        TreeTable.prototype.onColumnResizeEnd = function (event, column) {
            ...
            if (columnWidth + delta > parseInt(minWidth)) {
                if (this.columnResizeMode === 'fit') {
                    ...
                    if (nextColumn) {
                        ...
                        if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                            if (this.scrollable) {
                                ...
                                var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, '.ui-treetable-scrollable-body table') || dom.DomHandler.findSingle(scrollableView, '.ui-treetable-virtual-scrollable-body table');
                    ...
                    if (this.scrollable) {
                        var scrollableView = this.findParentScrollableView(column);
                        var scrollableBody_1 = dom.DomHandler.findSingle(scrollableView, '.ui-treetable-scrollable-body') || dom.DomHandler.findSingle(scrollableView, 'cdk-virtual-scroll-viewport');
                        var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, '.ui-treetable-scrollable-body table') || dom.DomHandler.findSingle(scrollableView, 'cdk-virtual-scroll-viewport table');
...
TreeTableModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function TreeTableModule_Factory(t) { return new (t || TreeTableModule)(); }, imports: [[common.CommonModule, paginator.PaginatorModule, scrolling.ScrollingModule], ɵngcc4.SharedModule, ɵngcc3.ScrollingModule] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TreeTableModule, { declarations: [TreeTable, TreeTableToggler, TTScrollableView, TTBody, TTSortableColumn, TTSortIcon, TTResizableColumn, TTRow, TTReorderableColumn, TTSelectableRow, TTSelectableRowDblClick, TTContextMenuRow, TTCheckbox, TTHeaderCheckbox, TTEditableColumn, TreeTableCellEditor], imports: [ɵngcc1.CommonModule, ɵngcc2.PaginatorModule, ɵngcc3.ScrollingModule], exports: [TreeTable, ɵngcc4.SharedModule, TreeTableToggler, TTSortableColumn, TTSortIcon, TTResizableColumn, TTRow, TTReorderableColumn, TTSelectableRow, TTSelectableRowDblClick, TTContextMenuRow, TTCheckbox, TTHeaderCheckbox, TTEditableColumn, TreeTableCellEditor, ɵngcc3.ScrollingModule] }); })();
