(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/api'), require('@angular/animations')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/toast', ['@angular/core','@angular/common','primeng-lts/api','exports', '@angular/core', '@angular/common', 'primeng-lts/dom', 'primeng-lts/api', '@angular/animations'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].toast = {}), global.ng.core, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].api, global.ng.animations));
...
function ToastItem_a_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function ToastItem_a_3_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); var ctx_r4 = ɵngcc0.ɵɵnextContext(); return ctx_r4.onCloseIconClick($event); })("keydown.enter", function ToastItem_a_3_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r5); var ctx_r6 = ɵngcc0.ɵɵnextContext(); return ctx_r6.onCloseIconClick($event); });
    ɵngcc0.ɵɵelementEnd();
} }
...
var _c5 = function (a1, a2, a3, a4, a5, a6, a7) { return { "ui-toast ui-widget": true, "ui-toast-top-right": a1, "ui-toast-top-left": a2, "ui-toast-bottom-right": a3, "ui-toast-bottom-left": a4, "ui-toast-top-center": a5, "ui-toast-bottom-center": a6, "ui-toast-center": a7 }; };
'use strict';
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ToastModule, { declarations: [Toast, ToastItem], imports: [ɵngcc1.CommonModule], exports: [Toast, ɵngcc2.SharedModule] }); })();
