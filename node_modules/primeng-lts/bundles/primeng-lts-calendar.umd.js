(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/button'), require('primeng-lts/dom'), require('primeng-lts/api'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/calendar', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/button', 'primeng-lts/dom', 'primeng-lts/api', '@angular/forms'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].calendar = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].button, global['primeng-lts'].dom, global['primeng-lts'].api, global.ng.forms));
