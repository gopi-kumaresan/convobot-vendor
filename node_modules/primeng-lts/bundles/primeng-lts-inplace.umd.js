(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/button'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/button')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/inplace', ['@angular/core','@angular/common','primeng-lts/button','exports', '@angular/core', '@angular/common', 'primeng-lts/button'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.button,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].inplace = {}), global.ng.core, global.ng.common, global['primeng-lts'].button));
...
function Inplace_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Inplace_div_1_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r3); var ctx_r2 = ɵngcc0.ɵɵnextContext(); return ctx_r2.onActivateClick($event); })("keydown", function Inplace_div_1_Template_div_keydown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r3); var ctx_r4 = ɵngcc0.ɵɵnextContext(); return ctx_r4.onKeydown($event); });
...
function Inplace_div_2_button_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Inplace_div_2_button_2_Template_button_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r7); var ctx_r6 = ɵngcc0.ɵɵnextContext(2); return ctx_r6.onDeactivateClick($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
