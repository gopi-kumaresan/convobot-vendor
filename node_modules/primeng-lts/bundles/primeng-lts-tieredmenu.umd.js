(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/router'),exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('@angular/router')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/tieredmenu', ['@angular/core','@angular/common','@angular/router','exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', '@angular/router'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.router,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].tieredmenu = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global.ng.router));
...
'use strict';
    ...
    var TieredMenuSub = /** @class */ (function () {
        ...
        TieredMenuSub.prototype.findNextItem = function (item) {
            ...
            if (nextItem)
                return dom.DomHandler.hasClass(nextItem, 'ui-state-disabled') || !dom.DomHandler.hasClass(nextItem, 'ui-menuitem') ? this.findNextItem(nextItem) : nextItem;
            else
                return null;
        };
        TieredMenuSub.prototype.findPrevItem = function (item) {
            ...
            if (prevItem)
                return dom.DomHandler.hasClass(prevItem, 'ui-state-disabled') || !dom.DomHandler.hasClass(prevItem, 'ui-menuitem') ? this.findPrevItem(prevItem) : prevItem;
            else
                return null;
        };
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TieredMenuModule, { declarations: [TieredMenu, TieredMenuSub], imports: [ɵngcc1.CommonModule, ɵngcc2.RouterModule], exports: [TieredMenu, ɵngcc2.RouterModule] }); })();
