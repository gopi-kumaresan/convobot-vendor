(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/inputtext'),require('primeng-lts/button'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/inputtext'), require('primeng-lts/button'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/inputnumber', ['@angular/core','@angular/common','primeng-lts/inputtext','primeng-lts/button','exports', '@angular/core', '@angular/common', 'primeng-lts/inputtext', 'primeng-lts/button', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.inputtext,global.primengLts.button,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].inputnumber = {}), global.ng.core, global.ng.common, global['primeng-lts'].inputtext, global['primeng-lts'].button, global.ng.forms));
