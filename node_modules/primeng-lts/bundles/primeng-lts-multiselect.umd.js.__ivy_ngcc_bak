(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('primeng-lts/api'), require('@angular/forms'), require('@angular/cdk/scrolling'), require('primeng-lts/tooltip')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/multiselect', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/utils', 'primeng-lts/api', '@angular/forms', '@angular/cdk/scrolling', 'primeng-lts/tooltip'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].multiselect = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].utils, global['primeng-lts'].api, global.ng.forms, global.ng.cdk.scrolling, global['primeng-lts'].tooltip));
