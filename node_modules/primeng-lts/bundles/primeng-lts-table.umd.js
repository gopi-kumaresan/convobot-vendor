(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/paginator'),require('@angular/cdk/scrolling'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/paginator'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('rxjs'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/table', ['@angular/core','@angular/common','primeng-lts/paginator','@angular/cdk/scrolling','primeng-lts/api','exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/paginator', 'primeng-lts/dom', 'primeng-lts/utils', 'rxjs', '@angular/cdk/scrolling'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.paginator,global.ng.cdk.scrolling,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].table = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].paginator, global['primeng-lts'].dom, global['primeng-lts'].utils, global.rxjs, global.ng.cdk.scrolling));
...
function Table_p_paginator_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function Table_p_paginator_5_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r14); var ctx_r13 = ɵngcc0.ɵɵnextContext(); return ctx_r13.onPageChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function Table_p_paginator_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onPageChange", function Table_p_paginator_8_Template_p_paginator_onPageChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r24); var ctx_r23 = ɵngcc0.ɵɵnextContext(); return ctx_r23.onPageChange($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(TableService, [{
    ...
    var Table = /** @class */ (function () {
                    ...
                    if (nextColumn) {
                        ...
                        if (newColumnWidth > 15 && nextColumnWidth > parseInt(nextColumnMinWidth)) {
                            if (this.scrollable) {
                                ...
                                var scrollableBodyTable = dom.DomHandler.findSingle(scrollableView, '.ui-table-scrollable-body table') || dom.DomHandler.findSingle(scrollableView, 'cdk-virtual-scroll-viewport table');
        ...
        Table.prototype.setScrollableItemsWidthOnExpandResize = function (column, newColumnWidth, delta) {
            ...
            var scrollableBody = dom.DomHandler.findSingle(scrollableView, '.ui-table-scrollable-body') || dom.DomHandler.findSingle(scrollableView, 'cdk-virtual-scroll-viewport');
            ...
            var scrollableBodyTable = dom.DomHandler.findSingle(scrollableBody, '.ui-table-scrollable-body table') || dom.DomHandler.findSingle(scrollableView, 'cdk-virtual-scroll-viewport table');
        ...
        Table.prototype.restoreColumnWidths = function () {
            if (this.columnWidthsState) {
                ...
                if (this.scrollable) {
                    ...
                    var bodyCols = this.virtualScroll ? dom.DomHandler.find(this.containerViewChild.nativeElement, 'cdk-virtual-scroll-viewport table > colgroup > col') : dom.DomHandler.find(this.containerViewChild.nativeElement, '.ui-table-scrollable-body table > colgroup > col');
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(SortIcon, [{
    ...
    var SelectableRow = /** @class */ (function () {
        ...
        __decorate([
            core.HostListener('keydown.enter', ['$event']),
            core.HostListener('keydown.shift.enter', ['$event']),
            core.HostListener('keydown.meta.enter', ['$event'])
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(TableModule, { declarations: [Table, SortableColumn, SelectableRow, RowToggler, ContextMenuRow, ResizableColumn, ReorderableColumn, EditableColumn, CellEditor, TableBody, ScrollableView, SortIcon, TableRadioButton, TableCheckbox, TableHeaderCheckbox, ReorderableRowHandle, ReorderableRow, SelectableRowDblClick, EditableRow, InitEditableRow, SaveEditableRow, CancelEditableRow], imports: [ɵngcc1.CommonModule, ɵngcc2.PaginatorModule, ɵngcc3.ScrollingModule], exports: [Table, ɵngcc4.SharedModule, SortableColumn, SelectableRow, RowToggler, ContextMenuRow, ResizableColumn, ReorderableColumn, EditableColumn, CellEditor, SortIcon, TableRadioButton, TableCheckbox, TableHeaderCheckbox, ReorderableRowHandle, ReorderableRow, SelectableRowDblClick, EditableRow, InitEditableRow, SaveEditableRow, CancelEditableRow, ɵngcc3.ScrollingModule] }); })();
