(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/colorpicker', ['@angular/core','@angular/common','exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].colorpicker = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global.ng.forms));
