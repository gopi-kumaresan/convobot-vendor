(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/dropdown'),require('@angular/forms'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('primeng-lts/dropdown'), require('primeng-lts/api')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/paginator', ['@angular/core','@angular/common','primeng-lts/dropdown','@angular/forms','primeng-lts/api','exports', '@angular/core', '@angular/common', '@angular/forms', 'primeng-lts/dropdown', 'primeng-lts/api'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.dropdown,global.ng.forms,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].paginator = {}), global.ng.core, global.ng.common, global.ng.forms, global['primeng-lts'].dropdown, global['primeng-lts'].api));
...
function Paginator_div_0_a_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Paginator_div_0_a_5_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r10); var ctx_r9 = ɵngcc0.ɵɵnextContext(2); return ctx_r9.changePageToPrev($event); })("keydown.enter", function Paginator_div_0_a_5_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r10); var ctx_r11 = ɵngcc0.ɵɵnextContext(2); return ctx_r11.changePageToPrev($event); });
...
function Paginator_div_0_a_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Paginator_div_0_a_7_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r14); var pageLink_r12 = ctx.$implicit; var ctx_r13 = ɵngcc0.ɵɵnextContext(2); return ctx_r13.onPageLinkClick($event, pageLink_r12 - 1); })("keydown.enter", function Paginator_div_0_a_7_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r14); var pageLink_r12 = ctx.$implicit; var ctx_r15 = ɵngcc0.ɵɵnextContext(2); return ctx_r15.onPageLinkClick($event, pageLink_r12 - 1); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
function Paginator_div_0_a_8_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Paginator_div_0_a_8_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r17); var ctx_r16 = ɵngcc0.ɵɵnextContext(2); return ctx_r16.changePageToNext($event); })("keydown.enter", function Paginator_div_0_a_8_Template_a_keydown_enter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r17); var ctx_r18 = ɵngcc0.ɵɵnextContext(2); return ctx_r18.changePageToNext($event); });
...
function Paginator_div_0_p_dropdown_11_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("ngModelChange", function Paginator_div_0_p_dropdown_11_Template_p_dropdown_ngModelChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r24); var ctx_r23 = ɵngcc0.ɵɵnextContext(2); return ctx_r23.rows = $event; })("onChange", function Paginator_div_0_p_dropdown_11_Template_p_dropdown_onChange_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r24); var ctx_r25 = ɵngcc0.ɵɵnextContext(2); return ctx_r25.onRppChange($event); });
...
function Paginator_div_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function Paginator_div_0_Template_a_click_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); var ctx_r27 = ɵngcc0.ɵɵnextContext(); return ctx_r27.changePageToFirst($event); })("keydown.enter", function Paginator_div_0_Template_a_keydown_enter_3_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); var ctx_r29 = ɵngcc0.ɵɵnextContext(); return ctx_r29.changePageToFirst($event); });
    ...
    ɵngcc0.ɵɵlistener("click", function Paginator_div_0_Template_a_click_9_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); var ctx_r30 = ɵngcc0.ɵɵnextContext(); return ctx_r30.changePageToLast($event); })("keydown.enter", function Paginator_div_0_Template_a_keydown_enter_9_listener($event) { ɵngcc0.ɵɵrestoreView(_r28); var ctx_r31 = ɵngcc0.ɵɵnextContext(); return ctx_r31.changePageToLast($event); });
