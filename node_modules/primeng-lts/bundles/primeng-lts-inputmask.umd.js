(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('primeng-lts/inputtext'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/inputtext'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/inputmask', ['@angular/core','primeng-lts/inputtext','@angular/common','exports', '@angular/core', '@angular/common', 'primeng-lts/dom', 'primeng-lts/inputtext', '@angular/forms'], factory) :
    (global = global || self, factory(global.ng.core,global.primengLts.inputtext,global.ng.common,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].inputmask = {}), global.ng.core, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].inputtext, global.ng.forms));
