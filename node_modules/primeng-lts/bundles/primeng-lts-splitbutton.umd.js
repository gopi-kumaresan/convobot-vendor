(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/router'),require('@angular/common'),require('primeng-lts/button'),exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/button'), require('@angular/router'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/splitbutton', ['@angular/core','@angular/router','@angular/common','primeng-lts/button','exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/button', '@angular/router', 'primeng-lts/utils'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.router,global.ng.common,global.primengLts.button,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].splitbutton = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].button, global.ng.router, global['primeng-lts'].utils));
...
function SplitButton_div_5_ng_template_3_li_1_a_1_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    var item_r5 = ɵngcc0.ɵɵnextContext(3).$implicit;
...
function SplitButton_div_5_ng_template_3_li_1_a_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SplitButton_div_5_ng_template_3_li_1_a_1_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r15); var item_r5 = ɵngcc0.ɵɵnextContext(2).$implicit; var ctx_r13 = ɵngcc0.ɵɵnextContext(2); return ctx_r13.itemClick($event, item_r5); });
    ...
    var item_r5 = ɵngcc0.ɵɵnextContext(2).$implicit;
...
function SplitButton_div_5_ng_template_3_li_1_a_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function SplitButton_div_5_ng_template_3_li_1_a_2_Template_a_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r21); var item_r5 = ɵngcc0.ɵɵnextContext(2).$implicit; var ctx_r19 = ɵngcc0.ɵɵnextContext(2); return ctx_r19.itemClick($event, item_r5); });
...
function SplitButton_div_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("@overlayAnimation.start", function SplitButton_div_5_Template_div_animation_overlayAnimation_start_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r25); var ctx_r24 = ɵngcc0.ɵɵnextContext(); return ctx_r24.onOverlayAnimationStart($event); });
