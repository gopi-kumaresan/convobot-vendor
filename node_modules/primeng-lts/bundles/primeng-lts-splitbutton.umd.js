(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/button'), require('@angular/router'), require('primeng-lts/utils')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/splitbutton', ['exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/button', '@angular/router', 'primeng-lts/utils'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].splitbutton = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].button, global.ng.router, global['primeng-lts'].utils));
