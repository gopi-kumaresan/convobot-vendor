(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/listbox', ['exports', '@angular/core', '@angular/common', 'primeng-lts/api', 'primeng-lts/dom', 'primeng-lts/utils', '@angular/forms'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].listbox = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].dom, global['primeng-lts'].utils, global.ng.forms));
