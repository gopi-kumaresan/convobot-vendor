(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('@angular/cdk/scrolling'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/api'), require('@angular/cdk/scrolling')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/virtualscroller', ['@angular/core','@angular/common','@angular/cdk/scrolling','primeng-lts/api','exports', '@angular/core', '@angular/common', 'primeng-lts/api', '@angular/cdk/scrolling'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.ng.cdk.scrolling,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].virtualscroller = {}), global.ng.core, global.ng.common, global['primeng-lts'].api, global.ng.cdk.scrolling));
