(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('primeng-lts/button')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/inplace', ['exports', '@angular/core', '@angular/common', 'primeng-lts/button'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].inplace = {}), global.ng.core, global.ng.common, global['primeng-lts'].button));
