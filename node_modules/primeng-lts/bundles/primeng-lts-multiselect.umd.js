(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common'),require('primeng-lts/tooltip'),require('@angular/cdk/scrolling'),require('primeng-lts/api'),exports, require('@angular/core'), require('@angular/animations'), require('@angular/common'), require('primeng-lts/dom'), require('primeng-lts/utils'), require('primeng-lts/api'), require('@angular/forms'), require('@angular/cdk/scrolling'), require('primeng-lts/tooltip')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/multiselect', ['@angular/core','@angular/common','primeng-lts/tooltip','@angular/cdk/scrolling','primeng-lts/api','exports', '@angular/core', '@angular/animations', '@angular/common', 'primeng-lts/dom', 'primeng-lts/utils', 'primeng-lts/api', '@angular/forms', '@angular/cdk/scrolling', 'primeng-lts/tooltip'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common,global.primengLts.tooltip,global.ng.cdk.scrolling,global.primengLts.api,(global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].multiselect = {}), global.ng.core, global.ng.animations, global.ng.common, global['primeng-lts'].dom, global['primeng-lts'].utils, global['primeng-lts'].api, global.ng.forms, global.ng.cdk.scrolling, global['primeng-lts'].tooltip));
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(MultiSelectModule, { declarations: [MultiSelect, MultiSelectItem], imports: [ɵngcc1.CommonModule, ɵngcc4.SharedModule, ɵngcc3.ScrollingModule, ɵngcc2.TooltipModule], exports: [MultiSelect, ɵngcc4.SharedModule, ɵngcc3.ScrollingModule] }); })();
