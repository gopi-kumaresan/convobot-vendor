(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/cdk/scrolling'), require('@angular/common'), require('primeng-lts/api'), require('primeng-lts/utils'), require('primeng-lts/dom')) :
    typeof define === 'function' && define.amd ? define('primeng-lts/tree', ['exports', '@angular/core', '@angular/cdk/scrolling', '@angular/common', 'primeng-lts/api', 'primeng-lts/utils', 'primeng-lts/dom'], factory) :
    (global = global || self, factory((global['primeng-lts'] = global['primeng-lts'] || {}, global['primeng-lts'].tree = {}), global.ng.core, global.ng.cdk.scrolling, global.ng.common, global['primeng-lts'].api, global['primeng-lts'].utils, global['primeng-lts'].dom));
